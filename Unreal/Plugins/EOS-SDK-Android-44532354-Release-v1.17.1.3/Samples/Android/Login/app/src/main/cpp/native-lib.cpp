...
std::string GetLoggedInDisplayName() {
    ...
    return {bSuccessful ? LocalUserInfo->DisplayName : ""};
}

extern "C"
JNIEXPORT jstring JNICALL
Java_com_epicgames_mobile_login_MainActivity_GetUsername(JNIEnv *, jobject) {
...
Java_com_epicgames_mobile_login_MainActivity_Logout(JNIEnv *, jobject) {
    EOS_HAuth AuthHandle = EOS_Platform_GetAuthInterface(PlatformHandle);
...
Java_com_epicgames_mobile_login_MainActivity_IsLoggedIn(JNIEnv *, jobject) {
    if (PlatformHandle == nullptr) {
        return false;
    }
...
extern "C" JNIEXPORT void JNICALL
Java_com_epicgames_mobile_login_MainActivity_LoginWithAccountPortal(JNIEnv *, jobject) {
    EOS_Auth_Credentials Credentials = {};
    Credentials.ApiVersion = EOS_AUTH_CREDENTIALS_API_LATEST;
...
extern "C" JNIEXPORT void JNICALL
Java_com_epicgames_mobile_login_MainActivity_Tick(JNIEnv *, jobject) {
...
Java_com_epicgames_mobile_login_MainActivity_Suspend(JNIEnv *, jobject) {
...
extern "C"
JNIEXPORT void JNICALL
Java_com_epicgames_mobile_login_MainActivity_Resume(JNIEnv *, jobject) {
...
extern "C"
JNIEXPORT void JNICALL
Java_com_epicgames_mobile_login_MainActivity_NetworkChanged(JNIEnv *, jobject, jboolean connected) {
    UpdateNetwork(connected ? EOS_ENetworkStatus::EOS_NS_Online : EOS_ENetworkStatus::EOS_NS_Disabled);
}

extern "C"
JNIEXPORT void JNICALL
Java_com_epicgames_mobile_login_MainActivity_NetworkDisabled(JNIEnv *, jobject) {
...
extern "C"
JNIEXPORT void JNICALL
Java_com_epicgames_mobile_login_MainActivity_PassMainActivityInstance(JNIEnv *, jobject thiz) {
