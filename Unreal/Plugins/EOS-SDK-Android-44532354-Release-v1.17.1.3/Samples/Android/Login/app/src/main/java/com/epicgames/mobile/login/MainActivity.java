...
public class MainActivity extends Activity {
	...
	@SuppressWarnings("deprecation") android.telephony.PhoneStateListener phoneStateListener = null;
	...
	void updateNetworkConnection() {
		...
		if (wifiManager.isWifiEnabled()) {
			@SuppressWarnings("deprecation") WifiInfo info = wifiManager.getConnectionInfo();
	...
	void registerDataCallback() {
		...
		telephonyManager.listen(phoneStateListener, android.telephony.PhoneStateListener.LISTEN_DATA_CONNECTION_STATE);
	}
	...
	public void onPause() {
		...
		if (loginInProgress && BuildConfig.SimulateCrash) {
			throw new OutOfMemoryError("Simulating out of memory crash");
		}
	}
